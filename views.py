...
def problem_two(request):
  ...
  insturctor = Instructor.objects.all()

  for insturctor in insturctor:
      print(f'First Name: {insturctor.first_name} Last Name: {insturctor.last_name} hire date:{insturctor.hire_date}')
